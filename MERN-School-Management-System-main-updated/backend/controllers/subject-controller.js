...
const updateSubject = async (req, res) => {
    const { id } = req.params;
    const { subName, subCode, sessions, teacher } = req.body;

    try {
        const updatedSubject = await Subject.findByIdAndUpdate(
            id,
            { subName, subCode, sessions, teacher },
            { new: true }
        );
...
module.exports = { subjectCreate, freeSubjectList,updateSubject, classSubjects, getSubjectDetail, deleteSubjectsByClass, deleteSubjects, deleteSubject, allSubjects };